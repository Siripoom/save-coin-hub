const ROWS = [
  ...
  { type: "สินค้าอื่น ๆ", suitable: "โรงเรียน สำนักงาน อาคารพาณิชย์", highlight: "ปรับสินค้าได้ตามกลุ่มลูกค้า", maintenance: "เติมสินค้า ตรวจสต็อก และติดตามยอดขาย", note: "เหมาะกับพื้นที่เฉพาะกลุ่ม" },
]
